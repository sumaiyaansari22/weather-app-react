...
const APIkey = '6c02c5d0c04ae6c6b9fb02c46241bd60';
...
const App = () => {
  ...
  return (
    <div className='w-full h-screen bg-gradientBg bg-no-repeat bg-cover bg-center flex flex-col items-center justify-center px-4 lg:px-0'>
      {errorMsg && <div className='w-full flex justify-center text-white p-1 capitalize'>{`${errorMsg.response.data.message}`}</div>}
